...
@Slf4j
public class ShowIsoInformationAction extends JISOCreatorBaseAction {
    @Builder
    private ShowIsoInformationAction(String message, String tooltip, ImageDescriptor imageDescriptor) {
    ...
    public void run() {
        ...
        IsoFileSystem isoFileSystem = (IsoFileSystem) isoDirectoriesTree.getInput();
        ...
        case Window.OK: {
            ...
            mainWindow.setStatus(isoExplorer
