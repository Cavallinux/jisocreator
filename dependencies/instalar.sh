...
$MVN_HOME/bin/mvn install:install-file -Dfile=org.eclipse.swt/org.eclipse.swt-linux-x86_64.jar -DgroupId=org.eclipse.swt -DartifactId=swt-linux-x86_64 -Dversion=3.4.0 -Dsources=../dependencies-sources/org.eclipse.swt/org.eclipse.swt.zip -Dpackaging=jar

$MVN_HOME/bin/mvn install:install-file -Dfile=org.eclipse.jface/org.eclipse.jface.jar -DgroupId=org.eclipse.jface -DartifactId=jface -Dversion=3.4.0 -Dsources=../dependencies-sources/org.eclipse.jface/org.eclipse.jface.jar -Dpackaging=jar
