...
public class GoToParentAction extends JISOCreatorBaseAction {
    ...
    private GoToParentAction(String message, String tooltip, ImageDescriptor imageDescriptor) {
        ...
        /*message(OSExplorerMessages.osExplorerGoToParentActionName).tooltip(OSExplorerMessages.osExplorerGoToParentActionToolTip).imageDescriptor(ImageRegister.INSTANCE.getImageUtils().loadImageDescriptor("up.png"));
