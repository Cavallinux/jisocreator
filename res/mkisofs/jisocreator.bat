...
start "" /b "%JAVA_HOME%\bin\javaw.exe" -Dpath.logs="%JISOCREATOR_LOGS%" --add-opens java.base/java.util=ALL-UNNAMED --enable-native-access=ALL-UNNAMED -Dorg.eclipse.swt.internal.win32.useDarkModeExplorerTheme=true -Dorg.eclipse.swt.internal.win32.useShellTitleColoring=true -jar "%SCRIPT_DIR%\jisocreator.jar" !APP_ARGS!
exit /b 0
